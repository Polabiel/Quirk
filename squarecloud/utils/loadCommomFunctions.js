...
function default_1(bot, baileysMessage) {
    ...
    const sendTextWithRemotejid = (text, remoteJidMessage, emoji) => __awaiter(this, void 0, void 0, function* () {
        if (emoji) {
            return yield bot.sendMessage(remoteJidMessage, {
                text: `${general_1.general.PREFIX_EMOJI} ${text}`,
            });
        }
        return yield bot.sendMessage(remoteJidMessage, { text: `${text}` });
    });
    ...
    const sendImageFromFile = (file, text, mention) => __awaiter(this, void 0, void 0, function* () {
        return yield bot.sendMessage(remoteJid, {
            image: { url: file },
            caption: text,
            mentions: mention !== null && mention !== void 0 ? mention : undefined,
        });
    });
