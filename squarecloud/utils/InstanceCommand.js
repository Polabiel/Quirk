...
const onAntiSpam_1 = require("../middlewares/onAntiSpam");
...
function default_1(bot, baileysMessage) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!groupSecure)
            return;
        if ((0, onAntiSpam_1.isFiltered)(data.user))
            return;
        try {
            (0, onAntiSpam_1.addFilter)(data.user);
            ...
            if (error instanceof InvalidParameterError_1.InvalidParameterError) {
                ...
                error instanceof Forbidden_1.Forbidden ||
                error.message === "not-authorized") {
                yield data.sendErrorReply(`Eu não tenho permissão para fazer isso!\n\n📄 *Solução*: Colocar o ${general_1.general.BOT_NAME} como administrador do grupo`);
            }
            else {
                (0, createLog_1.logCreate)(error);
                yield data.sendErrorReply(`Ocorreu um erro não identificado ao executar o comando ${command === null || command === void 0 ? void 0 : command.default.name}!\n\n💻 O desenvolvedor foi notificado!`);
