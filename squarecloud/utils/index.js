...
const getContentUnique = (baileysMessage, type) => {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    return ((_d = (_c = (_b = (_a = baileysMessage.message) === null || _a === void 0 ? void 0 : _a.viewOnceMessageV2) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c[`${type}Message`]) !== null && _d !== void 0 ? _d : (_h = (_g = (_f = (_e = baileysMessage.message) === null || _e === void 0 ? void 0 : _e.extendedTextMessage) === null || _f === void 0 ? void 0 : _f.contextInfo) === null || _g === void 0 ? void 0 : _g.quotedMessage) === null || _h === void 0 ? void 0 : _h[`${type}Message`]);
};
exports.getContentUnique = getContentUnique;
...
const downloadSticker = (baileysMessage) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, exports.downloadContent)(baileysMessage, "input", "sticker", "webp");
});
exports.downloadSticker = downloadSticker;
const downloadAudio = (baileysMessage) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, exports.downloadContent)(baileysMessage, "input", "audio", "mp3");
});
...
const downloadContent = (baileysMessage, fileName, context, extension) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const contentUnique = (0, exports.getContentUnique)(baileysMessage, context);
    if (content) {
    ...
    if (contentUnique) {
        const stream = yield (0, baileys_1.downloadContentFromMessage)(contentUnique, context);
        let buffer = Buffer.from([]);
        try {
            for (var _h = true, stream_2 = __asyncValues(stream), stream_2_1; stream_2_1 = yield stream_2.next(), _d = stream_2_1.done, !_d; _h = true) {
                _f = stream_2_1.value;
                _h = false;
                const chunk = _f;
                buffer = Buffer.concat([buffer, chunk]);
            ...
            try {
                if (!_h && !_d && (_e = stream_2.return)) yield _e.call(stream_2);
            }
